...
(define (problem shakey_1)
  ...
  (:objects
   r-1 r-2 r-3 - room
   shakey-1 - shakey
   d-1w d-2 d-3w d1 d2  - door
   l-1 l-2 l-3 - lightswitch
   b-1 b-2 - box
   exodia exodia-leftarm exodia-rightarm exodia-leftleg exodia-rightleg t1 t2  - toy)
  (:init  (at shakey-1 r-1)
	  ...
	  (connecting d1 r-1 r-2)(connecting d1 r-2 r-1)
	  (connecting d2 r-1 r-2)(connecting d2 r-2 r-1)
	;  (connecting d3 r-1 r-2)(connecting d3 r-2 r-1)
